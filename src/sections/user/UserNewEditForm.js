      ...
      <Grid container spacing={3}>
                ...
                label={
                  <>
                    <Typography variant="subtitle2" sx={{ mb: 0.5 }}>
                      {translate("profile.banned")}
                    </Typography>
                    <Typography
                      variant="body2"
                      sx={{ color: "text.secondary" }}
                    >
                      {translate("profile.applyDisableAccount")}
                    </Typography>
                  </>
                }
              ...
              label={
                <>
                  ...
                  <Typography variant="body2" sx={{ color: "text.secondary" }}>
                    {translate("profile.disablingThis")}
                  </Typography>
                </>
              }
        ...
        <Grid item xs={12} md={8}>
          <Card sx={{ p: 3 }}>
            ...
            >
              <RHFTextField name="name" label={translate("profile.fullName")} />
              <RHFTextField
                name="email"
              ...
              <RHFSelect
                ...
                placeholder={translate("profile.country")}
              >
                <option value="" />
              ...
              />
              <RHFTextField name="city" label={translate("profile.city")} />
              <RHFTextField
                name="address"
              ...
              <RHFTextField
                name="company"
                label={translate("profile.company")}
              />
              <RHFTextField name="role" label={translate("profile.role")} />
            </Box>
