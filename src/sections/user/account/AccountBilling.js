        ...
        <Stack spacing={3}>
          <Card sx={{ p: 3 }}>
            <Typography variant="overline" sx={{ mb: 3, display: 'block', color: 'text.secondary' }}>
              {translate("headerSettings.yourPlan")} 
            </Typography>
            <Typography variant="h4"> {translate("headerSettings.premium")}</Typography>
            <Box
              sx={{
                mt: { xs: 2, sm: 0 },
            ...
            >
              ...
              {translate("headerSettings.cancelPlan")}
              </Button>
              <Button size="small" variant="outlined">
               {translate("headerSettings.upgradePlan")}  
              </Button>
            </Box>
          </Card>
