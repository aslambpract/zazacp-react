    ...
    <Card sx={{ p: 3 }}>
      <Stack spacing={3} alignItems="flex-start">
        <Typography variant="overline" sx={{ color: "text.secondary" }}>
          {translate("headerSettings.billingInfo")}
        </Typography>
        ...
        {addressBook.map((address) => (
          ...
          >
            ...
            <Typography variant="body2" gutterBottom>
              ...
              >
                {translate("headerSettings.address")} : &nbsp;
              </Typography>
            ...
            <Typography variant="body2" gutterBottom>
              <Typography
                ...
                sx={{ color: "text.secondary" }}
              >
                {translate("headerSettings.phone")} : &nbsp;
              </Typography>
              {address.phone}
            </Typography>
            ...
            <Box sx={{ mt: 1 }}>
              <Button
                ...
                sx={{ mr: 1 }}
              >
                {translate("headerSettings.delete")}
              </Button>
              <Button
                size="small"
        ...
        <Button size="small" startIcon={<Iconify icon={"eva:plus-fill"} />}>
          {translate("headerSettings.addNewAddress")}
        </Button>
      </Stack>
    </Card>
  );
