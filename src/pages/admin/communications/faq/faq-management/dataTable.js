        ...
        <Scrollbar>
          <TableContainer sx={{ minWidth: 720 }}>
            <Table>
              <TableHead>
                <TableRow>
                  <TableCell>{translate("adminCommunication.faqs.no")}</TableCell>
                  <TableCell>{translate("adminCommunication.faqs.questions")}</TableCell>
                  <TableCell>{translate("adminCommunication.faqs.action")}</TableCell>
                  <TableCell />
                </TableRow>
              </TableHead>
              <TableBody>
