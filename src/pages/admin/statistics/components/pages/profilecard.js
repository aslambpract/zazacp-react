            ...
            <Grid container spacing={2}>
              <Grid item xs={6}>
                <Paper variant="outlined" sx={{ py: 1.5, textAlign: "center" }}>
                  ...
                  <Typography variant="body2" sx={{ color: "text.secondary" }}>
                   {translate("adminStatistics.userName")} 
                  </Typography>
                </Paper>
              </Grid>
              ...
              <Grid item xs={6}>
                <Paper variant="outlined" sx={{ py: 1.5, textAlign: "center" }}>
                  ...
                  <Typography variant="subtitle2">{translate("adminStatistics.active")}</Typography>
                  <Typography variant="body2" sx={{ color: "text.secondary" }}>
                  {translate("adminStatistics.status")} 
                  </Typography>
                </Paper>
              </Grid>
              <Grid item xs={6}>
                <Paper variant="outlined" sx={{ py: 1.5, textAlign: "center" }}>
                  ...
                  <Typography variant="body2" sx={{ color: "text.secondary" }}>
                    {translate("adminStatistics.phone")}
                  </Typography>
                </Paper>
              </Grid>
              <Grid item xs={6}>
                <Paper variant="outlined" sx={{ py: 1.5, textAlign: "center" }}>
                  ...
                  <Typography variant="body2" sx={{ color: "text.secondary" }}>
                   {translate("adminStatistics.email")} 
                  </Typography>
                </Paper>
              </Grid>
            </Grid>
            ...
            <Grid container spacing={2}>
              <Grid item xs={6}>
                <Paper variant="outlined" sx={{ py: 1.5, textAlign: "center" }}>
                  ...
                  <Typography variant="body2" sx={{ color: "text.secondary" }}>
                  {translate("adminStatistics.totalBalance")}
                  </Typography>
                </Paper>
              </Grid>
              ...
              <Grid item xs={6}>
                <Paper variant="outlined" sx={{ py: 1.5, textAlign: "center" }}>
                  ...
                  <Typography variant="body2" sx={{ color: "text.secondary" }}>
                   {translate("adminStatistics.balanceWallet")} 
                  </Typography>
                </Paper>
              </Grid>
              <Grid item xs={6}>
                <Paper variant="outlined" sx={{ py: 1.5, textAlign: "center" }}>
                  ...
                  <Typography variant="body2" sx={{ color: "text.secondary" }}>
                    {translate("adminStatistics.totalProducts")}
                  </Typography>
                </Paper>
              </Grid>
              <Grid item xs={6}>
                <Paper variant="outlined" sx={{ py: 1.5, textAlign: "center" }}>
                  ...
                  <Typography variant="body2" sx={{ color: "text.secondary" }}>
                   {translate("adminStatistics.referrals")} 
                  </Typography>
                </Paper>
              </Grid>
            </Grid>
