...
export default function EcommerceCheckout() {
  ...
  return (
    <Page title={translate("userBusinessBuilder.subscription.CheckoutTitile")}>
      <Container maxWidth={themeStretch ? false : "lg"}>
        <HeaderBreadcrumbs
          heading={translate("userBusinessBuilder.subscription.checkout")}
          links={[
            { name: translate("dashboard"), href: PATH_USER.root },
            {
              name: translate(
                "userBusinessBuilder.subscription.productSubscription"
              ),
              href: PATH_USER.onlineStore.productSubscription.root,
            },
            { name: translate("userBusinessBuilder.subscription.checkout") },
          ]}
        />
