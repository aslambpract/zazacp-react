      ...
      <Grid item xs={12} md={8}>
        <Card sx={{ mb: 3 }}>
          <CardHeader
            title={
              <Typography variant="h6">
                {translate("userFinancial.depositWallet.card")}
          ...
          {!isEmptyCart ? (
            ...
            <EmptyContent
              title={translate("userFinancial.depositWallet.cartIsEmpty")}
        ...
        >
          {translate("userFinancial.depositWallet.continueShopping")}
        </Button>
      </Grid>
