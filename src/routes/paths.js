...
export const PATH_DASHBOARD = {
  ...
  communication: {
    ...
    viewTickets: (id) =>
      path(ROOTS_DASHBOARD, `/communication/help-center/tickets/${id}`),
    newBlog: path(ROOTS_DASHBOARD, "/communication/blog/new"),
    editBlog: (bid) => path(ROOTS_DASHBOARD, `/communication/blog/${bid}`),
    blog: path(ROOTS_DASHBOARD, "/communication/blog/posts/published"),
    com_faqs: path(ROOTS_DASHBOARD, "/communication/faqs"),
    mails: path(ROOTS_DASHBOARD, "/communication/mails/all"),
...
export const PATH_USER = {
  ...
  onlineStore: {
    ...
    productSubscription: {
      ...
      checkout: path(ROOTS_USER, "/online-store/product-subscription/checkout"),
  ...
  helpCenter: {
    ...
    faq: {
      ...
      view: (view = "payment") => path(ROOTS_USER, `/help-center/faqs/${view}`),
    },
    knowledgeBase: {
